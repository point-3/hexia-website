...
export const DEFAULT_SITE_SETTINGS: SiteSettings = {
  ...
  header_navigation_links: [
    { key: "home", href: "/", label_en: "Home", label_zh: "首页", enabled: true, sort: 1 },
    { key: "products", href: "/products", label_en: "Products", label_zh: "产品中心", enabled: true, sort: 2 },
    { key: "service", href: "/service", label_en: "Service", label_zh: "服务", enabled: true, sort: 3 },
    { key: "about", href: "/about", label_en: "About Us", label_zh: "关于我们", enabled: true, sort: 4 },
    { key: "news", href: "/news", label_en: "News", label_zh: "资讯", enabled: true, sort: 5 },
    { key: "contact", href: "/contact", label_en: "Contact Us", label_zh: "联系我们", enabled: true, sort: 6 },
  ],
